...
parser.add_argument('--output_dir', type=str,default='exp_out/prompt', help='output dir')
...
parser.add_argument('--pretrained_path', type=str,
                    default='./pretrained_ckpt/convnext_tiny_22k_1k_224.pth', help='pretrained model path')
...
if __name__ == "__main__":
    ...
    train(args, net, args.output_dir)